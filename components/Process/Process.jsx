...
export default function Process() {
  return (
    <>
      <div className="container relative m-auto py-10 text-center">
        ...
        {/* <div className="absolute top-0 left-0">
          <div className="imgLine mt-10 w-[100%] h-[400px] relative">
            <Image
        ...
        <div className="grid md:grid-cols-4 grid-cols-1 gap-4 process">
